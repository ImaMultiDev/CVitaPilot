...
export const ExperienceForm: React.FC<ExperienceFormProps> = ({
  ...
  const { dispatch, addExperience } = useCV();
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (experience) {
      dispatch({
        ...
        payload: { ...formData, id: experience.id },
      });
    } else {
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Textarea
          label="Tecnologías utilizadas (separadas por comas)"
        ...
        <div className="flex justify-end space-x-3">
          ...
          <Button type="submit">
            {experience ? "Actualizar" : "Crear"} experiencia
          </Button>
        </div>
      </form>
    </Modal>
