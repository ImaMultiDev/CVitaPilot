...
export const FormatSelector: React.FC<FormatSelectorProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-lg no-print">
      <div className="text-center">
        <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4 flex items-center justify-center gap-3">
          <CVFormatIcon
            size={24}
        ...
        <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 text-sm text-gray-600 dark:text-gray-400">
          {cvFormat === "visual" ? (
            ...
            <div className="flex items-start gap-3">
              ...
              />
              <div className="text-left">
                <strong className="text-green-600 dark:text-green-400 block mb-1">
